    ...
    <div className="mb-6">
      <div className="flex flex-wrap gap-2 items-center text-sm font-medium mb-4">
        ...
        <button
          ...
          className={`px-3 py-1 rounded border transition inline-flex items-center gap-1 ${
            filtro5g
        ...
        {mostrarFiltros && (
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {marcas.length > 0 && (
                <div>
                  <p className="text-sm font-medium mb-2 border-b pb-2">
                    Marca
                  </p>
                    ...
                    {cores.map((cor) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            toggle(cor, coresSelecionadas, setCoresSelecionadas)
                          }
                        />
                        {cor}
                      </label>
